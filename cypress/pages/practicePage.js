...
export class practicePage {
  ...
  openNewTab(redirectedURL) {
    ...
    cy.get(this.webLocators.openNewTabButton).click()
  ...
  footerLinksValidation() {
    ...
    cy.get(this.webLocators.footerFacebook)
      .invoke('removeAttr', 'target')
      .click()
    cy.url().should('include', 'facebook')
    cy.go('back')
    cy.get(this.webLocators.footerYoutube)
      .invoke('removeAttr', 'target')
      .click()
    cy.url().should('include', 'youtube')
    cy.go('back')
    cy.get(this.webLocators.footerTwitter)
      .invoke('removeAttr', 'target')
      .click()
