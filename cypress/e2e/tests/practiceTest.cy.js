...
describe('Practice Page Test Automation', () => {
  ...
  it('Alert Modal Validation', function () {
    cy.task('readFileWhichMayExist', testData.alertTextPath).then((data) => {
      practicePageObj.invokeAlertModal(
        data,
        testData.alertStrFirstPart,
        testData.alertStrSecondPart,
      )
    })
  })
  ...
  it('Confirmation Modal Validation', function () {
    cy.task('readFileWhichMayExist', testData.alertTextPath).then((data) => {
      practicePageObj.invokeConfirmationModal(
        data,
        testData.confirmStrFirstPart,
        testData.confirmStrSecondPart,
      )
    })
  })
